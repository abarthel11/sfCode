...
export default class TicTacToeLeaderboard extends LightningElement {
  ...
  getMedalIcon(rank) {
    switch (rank) {
      case 1: return 'utility:trophy';
      case 2: return 'utility:medal';
      case 3: return 'utility:ribbon';
      default: return '';
    }
  }
  ...
  get showNoDataMessage() {
    return !this.isLoading && !this.error && (!this.leaderboardData || this.leaderboardData.length === 0);
  }
}